...
#define RUNNER_ARRAY_LENGTH_OUTPUT_FILE "./results/countingsort.array_length.csv"
#define RUNNER_INPUT_RANGE_OUTPUT_FILE "./results/countingsort.input_range.csv"
